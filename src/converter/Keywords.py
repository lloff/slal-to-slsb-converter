class Keywords:
    femdom = ['lesbian', 'femdom', 'ff', 'fff', 'ffff', 'fffff']
    futa = ['futa']
    sub = ['forced', 'rape', 'aggressive', 'aggressivedefault', 'bound', 'femdom', 'maledom', 'lezdom', 'gaydom', 'defeated', 'domsub', 'bdsm']
    dead = ['dead', 'necro', 'guro']
    ...
    dom = ['rough', 'bound', 'dominant', 'defeated', 'conquering', 'humiliation', 'domsub', 'femdom', 'femaledomination', 'maledom', 'lezdom', 'gaydom', 'bdsm']
    uses_only_agg_tag = ['leito', 'kom', 'flufyfox', 'gs', 'cobalt', 'mastermike', 'nya', 'rydin', 'nibbles', 'anubs']
    unconscious = ['necro', 'guro', 'gore', 'dead']
    futa = ['futa', 'futanari', 'futaxfemale']
    leadin_ = ['kissing', 'hugging', 'holding', 'loving', 'foreplay', 'lying', 'kneeling', 'cuddle', 'sfw', 'romance']
    not_leadin = ['vaginal', 'anal', 'oral', 'blowjob', 'cunnilingus', 'forced', 'sex', 'masturbation']
    magic = ['mage', 'staff', 'alteration', 'rune', 'magicdildo', 'magick']
    furni = [
