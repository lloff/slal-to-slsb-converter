...
class Categories:
    ...
    def get_categories(tags: list[str], scene_name: str, anim_dir_name: str) -> "Categories":
        categories = Categories()

        categories.futa = Tags.if_any_in_tags(tags, Keywords.futa, scene_name, anim_dir_name)
        categories.scaling = Tags.if_any_in_tags(tags, ['scaling'], scene_name, anim_dir_name)
        categories.leadin = Tags.if_any_in_tags(tags, ['leadin'], scene_name, anim_dir_name)
    ...
    def update_sub_categories(self, tags: list[str], scene_name: str, anim_dir_name: str) -> None:  
        ...
        self.sub_categories.gore = Tags.if_any_in_tags(tags, ['gore'], scene_name, anim_dir_name)
        ...
        self.sub_categories.asphyxiation = Tags.if_any_in_tags(tags, ['asphyxiation'], scene_name, anim_dir_name)
        self.sub_categories.spanking = Tags.if_any_in_tags(tags, ['spanking'], scene_name, anim_dir_name)
        ...
        #TODO: the sub tag insertion is a bit more complex. if a certain catrgory is not true and a tag for it is found then that tag shall be removed too
